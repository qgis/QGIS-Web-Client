...
// ABP: overview  map layers
//  wmsLoader.initialVisibleLayers.join(',') // automatic
var OVERVIEW_LAYERS='Catasto strade,PRG - Aree classificate';
...
function customAfterMapInit() {
    ...
    // ABP: load layers into the ref map
    overviewLayer.params.LAYERS=OVERVIEW_LAYERS;
    

    /* ABP: add east panel
    var eastPanel = Ext.create({
        xtype: 'panel',
        id: 'rgt',
        auto
        region: 'east',
    ...
    //var gb = Ext.getCmp('GisBrowserPanel');
    //gb.add(eastPanel);
    //gb.doLayout();
    //*/ 
}
