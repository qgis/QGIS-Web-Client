...
ThemeSwitcher.prototype.initialize = function () {
	me = this;
	var template = themeSwithcerTemplate?themeSwithcerTemplate:new Ext.XTemplate('<ul>', '<tpl for=".">', '<li class="project">', '<img width="450" height="200" class="thumbnail" src="/media/thumbnails/{projectfile}.png" title="{tooltip}" />', '<tpl if="pwprotected==\'yes\'">', '<img class="pwProtected" src="gis_icons/lockIcon.png" width="32" height="32" />','</tpl>','<strong>{projname}', '<tpl if="pwprotected==\'yes\'">', ' - ' + themeSwitcherTooltipPwProtectedString[lang], '</tpl>', '</strong>', '</li>', '</tpl>', '</ul>');
